...
% **************************************************
% Fix for Legacy commands found in template
% **************************************************
...
\newcommand{\thesisDate}{\thesisMonth \xspace \thesisYear}
...
\usepackage{afterpage} %used for inserting blank pages etc
...
%\cleardoublepage
\thesiscoverpage{PhD}%{Temporary Binding for Examination Purposes}
%\thesiscoverpage{MPhil}%{Temporary Binding for Examination Purposes}
\cleardoublepage
